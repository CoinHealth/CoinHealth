...
@section('content.inner')
	...
	<div class="row">
		<div class="container">
			<p class="question">Not including myself, someone in my family has or had the following medical conditions: <span class="color-blue">high blood
			pressure, high cholesterol</span></p>
