                ...
                <div class="col-md-6 nopadding">
                    <div class="ds-2">
                        ...
                        <div class="center mt-25">
                            <a href="/careconnect/create-doctor?premium=1" class="btn-primary btn-blue">Sounds good, Let's do it</a><br>
                            <a href="javascript:void(0);" data-dismiss="modal" aria-label="Close" class="not-now">Not now</a>
                        </div>
                    </div>
                </div>
            </div>
