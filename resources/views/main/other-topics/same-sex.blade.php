		...
		<div class="container">
			...
			<div class="row row-market row-2">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.samesex.part_1.ensures') !!}
					</p>
					<p>
						{!! trans('other.samesex.part_1.regardless') !!}
					</p>
				</div>
			...
			<div class="row row-market row-3">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.samesex.part_2.treats') !!}
					</p>
					<p>
						{!! trans('other.samesex.part_2.cases') !!}
					</p>
					<p>
						{!! trans('other.samesex.part_2.coverage') !!}
					</p>
				</div>
