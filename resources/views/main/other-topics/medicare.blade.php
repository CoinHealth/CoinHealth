		...
		<div class="container">
			...
			<div class="row">
				<div class="loss-title">
					<div class="col-md-12">
						...
						<div class="p-title">
							<p>{!! trans('other.medicare.title') !!}</p>
						</div>
					</div>
				</div>
			</div>
			<div class="row row-market row-2">
				<div class="col-md-offset-5 col-md-7">
					<p>
						 {!! trans('other.medicare.part_1.medicare') !!}
					</p>
					<p>
						{!! trans('other.medicare.part_1.marketplace') !!}
					</p>
					<p>
						{!! trans('other.medicare.part_1.important') !!}
					</p>
				</div>
			...
			<div class="row row-market row-3">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.medicare.part_2.part_a') !!}
					</p>
					<p>
						{!! trans('other.medicare.part_2.part_b') !!}
					</p>
					<p>
						{!! trans('other.medicare.part_2.tip') !!}
					</p>
				</div>
			...
			<div class="row row-market row-4">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.medicare.part_3.benefits') !!}
					</p>
					<p>
						{!! trans('other.medicare.part_3.save') !!}
					</p>
					<p>
						{!! trans('other.medicare.part_3.choice') !!}
					</p>
				</div>
