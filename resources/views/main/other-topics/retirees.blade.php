		...
		<div class="container">
				...
				<div class="loss-title">
					<div class="col-md-12">
						<div class="p-subtitle">
							<p>{!! trans('other.retirees.subtitle') !!}</p>
						</div>
						<div class="p-title">
							<p>{!! trans('other.retirees.title') !!}</p>
						</div>
					</div>
				</div>
			</div>
			<div class="row row-market row-2">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.retirees.desc1-1') !!}
					</p>
					<p>
						{!! trans('other.retirees.desc1-2') !!}
					</p>
					<p>
						{!! trans('other.retirees.desc1-3') !!}
					</p>
				</div>
			...
			<div class="row row-market row-3">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.retirees.desc2-1') !!}
					</p>
					<p>
						{!! trans('other.retirees.desc2-2') !!}
					</p>
				</div>
			...
			<div class="row row-market row-4">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.retirees.desc3-1') !!}
					</p>
					<p>
						{!! trans('other.retirees.desc3-2') !!}
					</p>
					<p>
						{!! trans('other.retirees.desc3-3') !!}
					</p>
				</div>
