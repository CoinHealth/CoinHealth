		...
		<div class="container">
				...
				<div class="loss-title">
					<div class="col-md-12">
						<div class="p-subtitle">
							<p>{!! trans('other.pregnant.subtitle') !!}</p>
						</div>
						<div class="p-title">
							<p>{!! trans('other.pregnant.title') !!}</p>
						</div>
					</div>
				</div>
			</div>
			<div class="row row-market row-2">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.pregnant.desc1-1') !!}
					</p>
					<p>
						{!! trans('other.pregnant.desc1-2') !!}
					</p>
					<p>
						{!! trans('other.pregnant.desc1-3') !!}
					</p>
				</div>
			...
			<div class="row row-market row-3">
				<div class="col-md-offset-5 col-md-7">
					<p>
						{!! trans('other.pregnant.desc2-1') !!}
					</p>
					<p>
						{!! trans('other.pregnant.desc2-1') !!}
					</p>
					<p>
						{!! trans('other.pregnant.desc2-3') !!}
					</p>
					<p>{!! trans('other.pregnant.desc2-4') !!}</p>
				</div>
