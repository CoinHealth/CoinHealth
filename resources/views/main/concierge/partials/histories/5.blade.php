...
<div class="row">
    <div class="container">
        <p class="question">
            Not including myself, someone in my family has or had the following medical conditions:
            <span class="selected-answers"></span>
        </p>
            ...
            <div class="col-md-12">
                <div class="box-selector">
                    <ul class="answers-list">
                        <li data-input data-checkbox data-selector="1">
                            <a >High Blood Pressure</a>
                        </li>
                        <li data-input data-checkbox data-selector="2">
                            <a >High Cholesterol</a>
                        </li>
                        <li data-input data-checkbox data-selector="3">
                            <a >Kidney Disease</a>
                        </li>
                        <li data-input data-checkbox data-selector="4">
                            <a >Liver Disease</a>
                        </li>
                        <li data-input data-checkbox data-selector="5">
                            <a >Osteoporosis</a>
                        </li>
                    </ul>
                ...
                <div class="continue">
                    <a class="btn-yellow" data-step="6">
                        CONTINUE
                    </a>
                </div>
            </div>
