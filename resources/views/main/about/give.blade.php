	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<p class="fancy"><span class="icon"><img src="/assets/icons/give.png" alt=""> {!! trans('about.give-fancy') !!}</span></p>
			</div>
		</div>
	</div>
</div>
...
<div class="content">
	...
	<div class="parrot">
		<img src="{!! trans('about.pic_give') !!}" class="img-responsive pull-right charitable" alt="">
	</div>

	<div class="clear"></div>

	<div class="back-2">
		<a href="/askparrot" class="a-back give-back">
