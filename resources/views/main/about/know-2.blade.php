...
<div class="content">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<p class="p-title">
					{!! trans('about.asst-macaw') !!}
				</p>
				<p>
					{!! trans('about.macaws-parrot') !!}
				</p>
				<p class="p-small">
					{!! trans('about.source') !!} nationalgeographic.com
				</p>
			</div>
			<div class="col-md-4">
				<p class="center">
			...
			<div class="back">
				<a href="/about/know" class="a-back"><img src="/assets/icons/back.png" alt=""></a>
			</div>
		</div>
	</div>
</div>
