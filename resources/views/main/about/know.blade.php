	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<p class="fancy"><span>{!! trans('about.know-fancy') !!}</span></p>
			</div>
		</div>
	</div>
</div>
...
<div class="content">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<p>
					{!! trans('about.custom-parrot') !!}
				</p>
				<p class="center">
    				<img src="/assets/icons/tabcare.png" class="typecare" alt="">
    			</p>
				<div class="next-back">
					<a href="/askparrot" class="a-back"><img src="/assets/icons/back.png" alt=""></a> <a href="/about/know-2" class="a-back"><img src="/assets/icons/next.png" alt=""></a>
				</div>
			</div>
		</div>
	</div>
