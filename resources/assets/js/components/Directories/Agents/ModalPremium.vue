                    ...
                    <div v-if="!is_subscribing">
                        <div class="row row-info">
                            ...
                            <div class="col-md-6 nopadding">
                                <div class="ds-2">
                                    <p class="modal-title">
                                        Ironically, we want YOU to go VIRAL.
                                    </p>
                                    <p class="modal-p">
                                        Make sure your business shows right on top of the search results on our Triage for only $9.99 annual.
                                    </p>
                                    <p class="modal-sub">
                                        Why is it worth it?
                                    </p>
                                    ...
                                    <div class="center mt-10">
                                        ...
                                        <a href="#" aria-label="Close" class="not-now">No Thanks</a>
                                    </div>
                                </div>
                            </div>
                        </div>
