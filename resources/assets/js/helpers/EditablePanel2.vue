...
<div :class="[editing ? 'panel-primary': 'panel-default', 'panel']">
    ...
    <div class="panel-footer">
        <div class="text-right">
            <transition name="popup">
                 <!-- v-show="buttons.edit" -->
                <button ref="btnEdit" key="a-edit" @click="editing = true" v-if="!editing" class="btn btn-xs btn-primary">
                    <i class="fa fa-pencil"></i> <span>Edit</span>
                </button>
            </transition>
            <transition name="popup">
                <button ref="btnDelete" v-show="buttons.delete" key="a-delete" @click="" v-if="!editing" class="btn btn-xs btn-danger">
