...
;(function (global, factory) {
    ...
    function loadLocale(name) {
        var oldLocale = null;
        // TODO:30 Find a better way to register and load all the locales in Node
    ...
    function setMonth (mom, value) {
        ...
        if (typeof value === 'string') {
            if (/^\d+$/.test(value)) {
                ...
                // TODO:20 Another silent failure?
    ...
    function dayOfYearFromWeekInfo(config) {
        ...
        if (w.GG != null || w.W != null || w.E != null) {
            ...
            // TODO:110 We need to take the current isoWeekYear, but that depends on
    ...
    function configFromStringAndFormat(config) {
        // TODO:60 Move this to another part of the creation flow to prevent circular deps
    ...
    // TODO:170 remove 'name' arg after deprecation is removed
	...
	helpers.arrayEquals = function(a0, a1) {
		...
		for (i = 0, ilen=a0.length; i < ilen; ++i) {
			...
			if (v0 instanceof Array && v1 instanceof Array) {
				...
				// NOTE:0 two different object instances will never be equal: {x:20} != {x:20}
				return false;
			}
		}
		...
		fit: function() {
			...
			if (tickOpts.display && display) {
				...
				if (isHorizontal) {
					...
					// TODO:10 - improve this calculation
